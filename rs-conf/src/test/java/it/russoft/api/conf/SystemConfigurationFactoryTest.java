 ...
 *
 */
public class SystemConfigurationFactoryTest {

    @Before
    public void configure(){
        System.setProperty("it.russoft.api.conf.STR_VAL", "127.0.0.1");
        System.setProperty("it.russoft.api.conf.INT_VAL", "12");
        System.setProperty("it.russoft.api.conf.STR_RGX", "^.*/be(?=/)");
        System.setProperty("it.russoft.api.conf.BOO_TRU", "true");
        System.setProperty("it.russoft.api.conf.BOO_FAL", "false");
        System.setProperty("it.russoft.api.conf.ARR_STR", "x, y");
    }

    @Test
    public void test(){
        ConfigurationFactory<String> factory = new SystemConfigurationFactory<>(
