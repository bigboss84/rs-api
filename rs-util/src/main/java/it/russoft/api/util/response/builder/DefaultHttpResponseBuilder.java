 ...
 *
 */
public class DefaultHttpResponseBuilder extends ServiceResponseBuilder {

    public DefaultHttpResponseBuilder(HttpContext context){
        super(context);
    }
    ...
    public void buildHeader(){
        ...
        HttpServletRequest r = ((HttpContext) this.context).getRequest();
